...
define('ayap/helpers/app-version', ['exports', 'ember', 'ayap/config/environment', 'ember-cli-app-version/utils/regexp'], function (exports, _ember, _ayapConfigEnvironment, _emberCliAppVersionUtilsRegexp) {
...
if (!runningTests) {
  require("ayap/app")["default"].create({"name":"ayap","version":"0.0.0+9719fc60"});
}
